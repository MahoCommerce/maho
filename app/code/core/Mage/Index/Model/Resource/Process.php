...
class Mage_Index_Model_Resource_Process extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    public function endProcess(Mage_Index_Model_Process $process)
    {
        $data = [
            ...
            'ended_at'  => Mage::app()->getLocale()->formatDateForDb(time()),
        ];
    ...
    public function startProcess(Mage_Index_Model_Process $process)
    {
        $data = [
            ...
            'started_at'    => Mage::app()->getLocale()->formatDateForDb(time()),
        ];
        $this->_updateProcessData($process->getId(), $data);
        return $this;
    }
    ...
    {
        $this->_updateProcessData($process->getId(), ['started_at' => Mage::app()->getLocale()->formatDateForDb(time())]);
        return $this;
    }
    ...
    {
        $this->_updateProcessData($process->getId(), ['ended_at' => Mage::app()->getLocale()->formatDateForDb(time())]);
        return $this;
    }
