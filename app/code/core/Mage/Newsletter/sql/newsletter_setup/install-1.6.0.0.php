...
$table = $installer->getConnection()
    ...
    ->addColumn('subscriber_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('subscriber_email', Maho\Db\Ddl\Table::TYPE_TEXT, 150, [
        'nullable'  => true,
        'default'   => null,
    ], 'Subscriber Email')
    ->addColumn('subscriber_status', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'nullable'  => false,
        'default'   => '0',
    ], 'Subscriber Status')
    ->addColumn('subscriber_confirm_code', Maho\Db\Ddl\Table::TYPE_TEXT, 32, [
        'default'   => 'NULL',
...
$table = $installer->getConnection()
    ...
    ->addColumn('template_text_preprocessed', Maho\Db\Ddl\Table::TYPE_TEXT, '64k', [
    ...
    ->addColumn('template_actual', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'default'   => '1',
    ], 'Template Actual')
...
$table = $installer->getConnection()
    ...
    ->addColumn('newsletter_type', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
    ], 'Newsletter Type')
    ->addColumn('newsletter_text', Maho\Db\Ddl\Table::TYPE_TEXT, '64k', [
    ], 'Newsletter Text')
    ->addColumn('newsletter_styles', Maho\Db\Ddl\Table::TYPE_TEXT, '64k', [
    ], 'Newsletter Styles')
    ->addColumn('newsletter_subject', Maho\Db\Ddl\Table::TYPE_TEXT, 200, [
    ], 'Newsletter Subject')
    ->addColumn('newsletter_sender_name', Maho\Db\Ddl\Table::TYPE_TEXT, 200, [
    ], 'Newsletter Sender Name')
    ->addColumn('newsletter_sender_email', Maho\Db\Ddl\Table::TYPE_TEXT, 200, [
    ], 'Newsletter Sender Email')
    ->addColumn('queue_status', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Queue Status')
...
$table = $installer->getConnection()
    ...
    ->addColumn('queue_link_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('problem_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('problem_error_code', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'unsigned'  => true,
        'default'   => '0',
    ], 'Problem Error Code')
    ->addColumn('problem_error_text', Maho\Db\Ddl\Table::TYPE_TEXT, 200, [
    ], 'Problem Error Text')
    ->addIndex(
