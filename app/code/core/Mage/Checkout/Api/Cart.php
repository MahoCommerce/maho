    ...
    graphQlOperations: [
        ...
        new Mutation(
            ...
            args: [
                ...
                'giftcardAmount' => ['type' => 'Float', 'description' => 'Gift card amount (giftcard products)'],
                'giftcardSenderName' => ['type' => 'String', 'description' => 'Gift card sender name'],
                'giftcardSenderEmail' => ['type' => 'String', 'description' => 'Gift card sender email'],
                'giftcardRecipientName' => ['type' => 'String', 'description' => 'Gift card recipient name'],
