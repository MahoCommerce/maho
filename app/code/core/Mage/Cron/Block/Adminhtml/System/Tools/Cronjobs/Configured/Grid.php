...
class Mage_Cron_Block_Adminhtml_System_Tools_Cronjobs_Configured_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('configuredCronjobsGrid');
    ...
    public function decorateActions(string $value, \Maho\DataObject $row, Mage_Adminhtml_Block_Widget_Grid_Column $column, bool $isExport): string
    {
        ...
        $label = Mage::helper('cron')->__('Run Now');

        return '<a href="#" onclick="cronRunJob(\'' . $jobCode . '\'); return false;">' . $label . '</a>';
    }
