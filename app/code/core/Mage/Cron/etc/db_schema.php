...
return function (Schema $schema): void {
    ...
    $t->addColumn('schedule_id', Types::INTEGER, [
        'unsigned' => true,
        'notnull' => true,
        'autoincrement' => true,
    ]);
    $t->addColumn('job_code', Types::STRING, [
        'length' => 255,
        'notnull' => true,
        'default' => '0',
    ]);
    ...
    $t->addColumn('messages', Types::TEXT, [
        'length' => 65535,
        'notnull' => false,
    ]);
    $t->addColumn('created_at', Types::DATETIME_MUTABLE, ['notnull' => true]);
