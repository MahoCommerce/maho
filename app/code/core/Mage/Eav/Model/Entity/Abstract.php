...
abstract class Mage_Eav_Model_Entity_Abstract extends Mage_Core_Model_Resource_Abstract implements Mage_Eav_Model_Entity_Interface
{
    ...
    {
        \Maho\Profiler::start('eav.model.load');
        /**
        ...
        $object->setOrigData();
        \Maho\Profiler::start('eav.model.after_load');

        $this->_afterLoad($object);
        \Maho\Profiler::stop('eav.model.after_load');

        \Maho\Profiler::stop('eav.model.load');
        return $this;
    }
    ...
    protected function _loadModelAttributes($object)
    {
        ...
        \Maho\Profiler::start('eav.model.load_attributes');
        ...
        \Maho\Profiler::stop('eav.model.load_attributes');
