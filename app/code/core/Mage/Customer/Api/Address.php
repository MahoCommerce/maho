...
#[ApiResource(
    ...
    operations: [
        ...
        new Put(
            ...
            security: "is_granted('ROLE_CUSTOMER') or is_granted('ROLE_ADMIN') or is_granted('addresses/write')",
        ),
        new Delete(
            uriTemplate: '/addresses/{id}',
        ...
        new GetCollection(
            ...
            security: "is_granted('ROLE_ADMIN') or is_granted('addresses/read')",
        ),
        new Post(
            ...
            security: "is_granted('ROLE_ADMIN') or is_granted('addresses/write')",
        ),
    ],
    graphQlOperations: [
