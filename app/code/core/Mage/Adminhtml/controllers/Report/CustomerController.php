...
{
    #[Route('/admin/report_customer/_init')]
    ...
    #[Route('/admin/report_customer/accounts')]
     ...
     */
    #[Route('/admin/report_customer/exportAccountsCsv')]
     ...
     */
    #[Route('/admin/report_customer/exportAccountsExcel')]
    ...
    #[Route('/admin/report_customer/orders')]
     ...
     */
    #[Route('/admin/report_customer/exportOrdersCsv')]
     ...
     */
    #[Route('/admin/report_customer/exportOrdersExcel')]
    ...
    #[Route('/admin/report_customer/totals')]
     ...
     */
    #[Route('/admin/report_customer/exportTotalsCsv')]
     ...
     */
    #[Route('/admin/report_customer/exportTotalsExcel')]
