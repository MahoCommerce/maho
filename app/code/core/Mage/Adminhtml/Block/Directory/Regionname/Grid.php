 ...
 */
class Mage_Adminhtml_Block_Directory_Regionname_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns(): self
    {
        ...
        $this->addColumn('country_id', [
            ...
            'index' => 'country_id',
            'type' => 'text',
            'renderer' => 'adminhtml/directory_regionname_grid_renderer_country',
        ]);
