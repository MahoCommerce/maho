...
class Mage_Adminhtml_Block_Directory_Regionname_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'directory_regionname';
    ...
    {
        $this->setChild('form', $this->getLayout()->createBlock('adminhtml/directory_regionname_edit_form'));
