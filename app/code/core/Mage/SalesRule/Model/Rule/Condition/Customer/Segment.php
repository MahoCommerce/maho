...
class Mage_SalesRule_Model_Rule_Condition_Customer_Segment extends Mage_Rule_Model_Condition_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setType('salesrule/rule_condition_customer_segment')
            ->setValue(null);
    }
    ...
    {
        $attributes = [
            'customer_segment' => Mage::helper('salesrule')->__('Customer Segment'),
        ];
