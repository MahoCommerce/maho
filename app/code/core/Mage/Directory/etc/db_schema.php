...
return function (Schema $schema): void {
    ...
    $country->addColumn('country_id', Types::STRING, ['length' => 2, 'notnull' => true, 'default' => '']);
    ...
    $countryFormat->addColumn('country_format_id', Types::INTEGER, ['unsigned' => true, 'notnull' => true, 'autoincrement' => true]);
    ...
    $countryFormat->addColumn('format', Types::TEXT, ['length' => 65535, 'notnull' => true]);
    ...
    $countryRegion->addColumn('region_id', Types::INTEGER, ['unsigned' => true, 'notnull' => true, 'autoincrement' => true]);
    $countryRegion->addColumn('country_id', Types::STRING, ['length' => 4,   'notnull' => true,  'default' => '0']);
    ...
    $regionName->addColumn('locale', Types::STRING, ['length' => 8,   'notnull' => true, 'default' => '']);
    $regionName->addColumn('region_id', Types::INTEGER, ['unsigned' => true, 'notnull' => true, 'default' => 0]);
    ...
    $countryName->addColumn('locale', Types::STRING, ['length' => 8,   'notnull' => true, 'default' => '']);
    $countryName->addColumn('country_id', Types::STRING, ['length' => 2,   'notnull' => true, 'default' => '']);
    ...
    $currencyRate->addColumn('currency_from', Types::STRING, ['length' => 3, 'notnull' => true, 'default' => '']);
    $currencyRate->addColumn('currency_to', Types::STRING, ['length' => 3, 'notnull' => true, 'default' => '']);
    $currencyRate->addColumn('rate', Types::DECIMAL, ['precision' => 24, 'scale' => 12, 'notnull' => true, 'default' => '0.000000000000']);
