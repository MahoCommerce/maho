...
$table = $installer->getConnection()
    ...
    ->addColumn('report_date', Maho\Db\Ddl\Table::TYPE_TIMESTAMP, null, [
    ], 'Report Date')
    ->addColumn('account_id', Maho\Db\Ddl\Table::TYPE_TEXT, 64, [
    ], 'Account Id')
...
$table = $installer->getConnection()
    ...
    ->addColumn('row_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('transaction_id', Maho\Db\Ddl\Table::TYPE_TEXT, 19, [
    ], 'Transaction Id')
    ->addColumn('invoice_id', Maho\Db\Ddl\Table::TYPE_TEXT, 127, [
    ], 'Invoice Id')
    ->addColumn('paypal_reference_id', Maho\Db\Ddl\Table::TYPE_TEXT, 19, [
    ], 'Paypal Reference Id')
    ->addColumn('paypal_reference_id_type', Maho\Db\Ddl\Table::TYPE_TEXT, 3, [
    ], 'Paypal Reference Id Type')
    ->addColumn('transaction_event_code', Maho\Db\Ddl\Table::TYPE_TEXT, 5, [
    ], 'Transaction Event Code')
    ->addColumn('transaction_initiation_date', Maho\Db\Ddl\Table::TYPE_TIMESTAMP, null, [
    ], 'Transaction Initiation Date')
    ->addColumn('transaction_completion_date', Maho\Db\Ddl\Table::TYPE_TIMESTAMP, null, [
    ], 'Transaction Completion Date')
    ->addColumn('transaction_debit_or_credit', Maho\Db\Ddl\Table::TYPE_TEXT, 2, [
        'nullable'  => false,
        'default'   => 'CR',
    ], 'Transaction Debit Or Credit')
    ->addColumn('gross_transaction_amount', Maho\Db\Ddl\Table::TYPE_DECIMAL, '20,6', [
        'nullable'  => false,
        'default'   => '0.000000',
    ], 'Gross Transaction Amount')
    ->addColumn('gross_transaction_currency', Maho\Db\Ddl\Table::TYPE_TEXT, 3, [
        'default'   => '',
    ], 'Gross Transaction Currency')
    ->addColumn('fee_debit_or_credit', Maho\Db\Ddl\Table::TYPE_TEXT, 2, [
    ], 'Fee Debit Or Credit')
    ->addColumn('fee_amount', Maho\Db\Ddl\Table::TYPE_DECIMAL, '20,6', [
        'nullable'  => false,
        'default'   => '0.000000',
    ], 'Fee Amount')
    ->addColumn('fee_currency', Maho\Db\Ddl\Table::TYPE_TEXT, 3, [
    ], 'Fee Currency')
    ->addColumn('custom_field', Maho\Db\Ddl\Table::TYPE_TEXT, 255, [
    ], 'Custom Field')
    ->addColumn('consumer_id', Maho\Db\Ddl\Table::TYPE_TEXT, 127, [
    ], 'Consumer Id')
    ->addIndex(
...
$table = $installer->getConnection()
    ...
    ->addColumn('cert_id', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
