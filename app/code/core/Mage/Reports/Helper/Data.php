...
class Mage_Reports_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getIntervals($from, $to, $period = self::REPORT_PERIOD_TYPE_DAY)
    {
        ...
        $start = DateTime::createFromFormat(Varien_Date::DATE_PHP_FORMAT, $from) ?: new DateTime($from);
        ...
        $dateEnd = DateTime::createFromFormat(Varien_Date::DATE_PHP_FORMAT, $to) ?: new DateTime($to);
