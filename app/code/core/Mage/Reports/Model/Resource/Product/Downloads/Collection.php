    ...
    public function addSummary()
    {
        ...
        $this->getSelect()
            ->joinInner(
                ...
                [
                    'purchases' => new Maho\Db\Expr('SUM(d.number_of_downloads_bought)'),
                    'downloads' => new Maho\Db\Expr('SUM(d.number_of_downloads_used)'),
                ],
            )
            ->joinInner(
            ...
            ->joinLeft(
                ...
                ['link_title' => new Maho\Db\Expr(sprintf('MAX(%s)', $linkExpr))],
            )
            ->where(implode(' OR ', [
