...
return function (Schema $schema): void {
    ...
    $productSuperAttribute->addForeignKeyConstraint('catalog_product_entity', ['product_id'], ['entity_id'], ['onUpdate' => 'CASCADE', 'onDelete' => 'NO ACTION'], 'fk_catalog_product_super_attribute_product');
    ...
    $productSuperAttributeLabel->addColumn('use_default', Types::SMALLINT, ['unsigned' => true, 'default' => 0]);
    ...
    $productSuperAttributePricing->addColumn('is_percent', Types::SMALLINT, ['unsigned' => true, 'default' => 0]);
    ...
    $productIndexWebsite->addColumn('rate', Types::FLOAT, ['default' => 1.0]);
    ...
    $urlRewrite->addForeignKeyConstraint('catalog_category_entity', ['category_id'], ['entity_id'], ['onUpdate' => 'CASCADE', 'onDelete' => 'NO ACTION'], 'fk_core_url_rewrite_category');
    $urlRewrite->addForeignKeyConstraint('catalog_product_entity', ['product_id'], ['entity_id'], ['onUpdate' => 'CASCADE', 'onDelete' => 'NO ACTION'], 'fk_core_url_rewrite_product');
};
