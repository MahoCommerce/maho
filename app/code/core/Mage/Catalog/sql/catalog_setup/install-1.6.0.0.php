...
$table = $installer->getConnection()
    ...
    ->addColumn('type_id', Maho\Db\Ddl\Table::TYPE_TEXT, 32, [
        'nullable'  => false,
        'default'   => Mage_Catalog_Model_Product_Type::DEFAULT_TYPE,
    ], 'Type ID')
    ->addColumn('sku', Maho\Db\Ddl\Table::TYPE_TEXT, 64, [
    ], 'SKU')
    ->addColumn('has_options', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'nullable'  => false,
        'default'   => '0',
    ], 'Has Options')
    ->addColumn('required_options', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Required Options')
...
$table = $installer->getConnection()
    ...
    ->addColumn('children_count', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'nullable'  => false,
    ], 'Child Count')
    ->addIndex(
...
$table = $installer->getConnection()
    ...
    ->addColumn('is_parent', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Parent')
    ...
    ->addColumn('visibility', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
    ], 'Visibility')
    ->addIndex(
...
$table = $installer->getConnection()
    ...
    ->addColumn('catalog_compare_item_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('link_type_id', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('linked_product_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Linked Product ID')
...
$table = $installer->getConnection()
    ...
    ->addColumn('product_link_attribute_id', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('product_link_attribute_code', Maho\Db\Ddl\Table::TYPE_TEXT, 32, [
        'nullable'  => true,
        'default'   => null,
    ], 'Product Link Attribute Code')
    ->addColumn('data_type', Maho\Db\Ddl\Table::TYPE_TEXT, 32, [
        'nullable'  => true,
        'default'   => null,
    ], 'Data Type')
    ->addIndex(
...
$table = $installer->getConnection()
    ...
    ->addColumn('product_super_attribute_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('use_default', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'default'   => '0',
    ], 'Use Default Value')
    ->addColumn('value', Maho\Db\Ddl\Table::TYPE_TEXT, 255, [
...
$table = $installer->getConnection()
    ...
    ->addColumn('value_index', Maho\Db\Ddl\Table::TYPE_TEXT, 255, [
        'nullable'  => true,
        'default'   => null,
    ], 'Value Index')
    ->addColumn('is_percent', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'default'   => '0',
    ], 'Is Percent')
    ->addColumn('pricing_value', Maho\Db\Ddl\Table::TYPE_DECIMAL, '12,4', [
    ], 'Pricing Value')
    ->addColumn('website_id', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
...
$table = $installer->getConnection()
    ...
    ->addColumn('disabled', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Disabled')
...
$table = $installer->getConnection()
    ...
    ->addColumn('type', Maho\Db\Ddl\Table::TYPE_TEXT, 50, [
        'nullable'  => true,
        'default'   => null,
    ], 'Type')
    ->addColumn('is_require', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'nullable'  => false,
        'default'   => '1',
    ], 'Is Required')
    ->addColumn('sku', Maho\Db\Ddl\Table::TYPE_TEXT, 64, [
    ], 'SKU')
    ->addColumn('max_characters', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'unsigned'  => true,
    ], 'Max Characters')
    ->addColumn('file_extension', Maho\Db\Ddl\Table::TYPE_TEXT, 50, [
    ], 'File Extension')
    ->addColumn('image_size_x', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned' => true,
    ], 'Image Size X')
    ->addColumn('image_size_y', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned' => true,
    ], 'Image Size Y')
...
$table = $installer->getConnection()
    ...
    ->addColumn('option_price_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ...
    ->addColumn('price_type', Maho\Db\Ddl\Table::TYPE_TEXT, 7, [
        'nullable'  => false,
        'default'   => 'fixed',
    ], 'Price Type')
    ->addIndex(
...
$table = $installer->getConnection()
    ...
    ->addColumn('option_title_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('option_type_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('option_type_price_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('option_type_title_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('frontend_input_renderer', Maho\Db\Ddl\Table::TYPE_TEXT, 255, [
    ...
    ->addColumn('is_searchable', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Searchable')
    ->addColumn('is_filterable', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Filterable')
    ->addColumn('is_comparable', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Comparable')
    ...
    ->addColumn('is_html_allowed_on_front', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is HTML Allowed On Front')
    ->addColumn('is_used_for_price_rules', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Used For Price Rules')
    ->addColumn('is_filterable_in_search', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Filterable In Search')
    ->addColumn('used_in_product_listing', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Used In Product Listing')
    ->addColumn('used_for_sort_by', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is Used For Sorting')
    ->addColumn('is_configurable', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '1',
    ], 'Is Configurable')
    ->addColumn('apply_to', Maho\Db\Ddl\Table::TYPE_TEXT, 255, [
        'nullable'  => true,
    ], 'Apply To')
    ->addColumn('is_visible_in_advanced_search', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ...
    ->addColumn('is_wysiwyg_enabled', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Is WYSIWYG Enabled')
    ->addColumn('is_used_for_promo_rules', Maho\Db\Ddl\Table::TYPE_SMALLINT, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
...
$table = $installer->getConnection()
    ...
    ->addColumn('child_id', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'primary'   => true,
    ], 'Child ID')
...
$table = $installer->getConnection()
    ...
    ->addColumn('final_price', Maho\Db\Ddl\Table::TYPE_DECIMAL, '12,4', [
    ], 'Final Price')
...
$table = $installer->getConnection()
    ...
    ->addColumn('website_date', Maho\Db\Ddl\Table::TYPE_DATE, null, [
    ], 'Website Date')
    ->addColumn('rate', Maho\Db\Ddl\Table::TYPE_FLOAT, null, [
        'default'   => '1.0000',
    ], 'Rate')
    ->addIndex(
...
$table = $installer->getConnection()
    ...
    ->addColumn('visibility', Maho\Db\Ddl\Table::TYPE_INTEGER, null, [
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
    ], 'Visibility')
