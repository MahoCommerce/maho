 ...
 */
final class ProductLinkWriter implements ProcessorInterface
{
    ...
    public function __construct(
        Security $security,
        private readonly ProductLinkReader $provider,
    ) {
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): ProductLink|array|null
    {
        ...
        $linkType = ProductLinkReader::extractLinkType($context);
        ...
        if ($operation instanceof DeleteOperationInterface) {
            ...
            $linkedProductId = ProductLinkReader::extractLinkedProductId($context);
