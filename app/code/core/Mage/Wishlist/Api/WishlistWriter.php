 ...
 */
final class WishlistWriter implements ProcessorInterface
{
    ...
    private function addToWishlist(int $productId, int $qty = 1, ?string $description = null): WishlistItem
    {
        ...
        $wishlist->save();
        WishlistReader::invalidateCache($customerId);
    ...
    // TODO: Extract getProductImageUrl() to a shared trait or service to eliminate duplication with WishlistReader/WishlistWriter
    /**
