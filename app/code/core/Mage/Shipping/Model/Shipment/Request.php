...
class Mage_Shipping_Model_Shipment_Request extends \Maho\DataObject
{
    ...
    public function setRecipientAddressRegionCode(?string $value): static
    {
        return $this->setData('recipient_address_region_code', $value);
    }
    ...
    public function setPackages(?array $value): static
    {
    ...
    public function setShipperEmail(?string $value): static
    {
        return $this->setData('shipper_email', $value);
    }
