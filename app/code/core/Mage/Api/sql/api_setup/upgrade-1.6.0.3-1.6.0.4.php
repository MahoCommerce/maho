...
if ($installer->getConnection() instanceof \Maho\Db\Adapter\Pdo\Mysql) {
    $columns = [
        ['api/session', 'logdate',  true,  null,                                     'Login date'],
        ['api/user',    'created',  false, Maho\Db\Ddl\Table::TIMESTAMP_INIT,        'User record create date'],
        ['api/user',    'modified', true,  null,                                     'User record modify date'],
    ];
