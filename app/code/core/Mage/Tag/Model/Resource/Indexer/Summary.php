            ...
            $select = $writeAdapter->select()
                ->from(
                    ...
                    [
                        ...
                        'uses'              => new Varien_Db_Expr('0'), // deprecated since 1.4.0.1
                        'historical_uses'   => new Varien_Db_Expr('0'), // deprecated since 1.4.0.1
                        'base_popularity'   => new Varien_Db_Expr('0'),  // deprecated since 1.4.0.1
                    ],
                )
                ->joinInner(
