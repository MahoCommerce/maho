...
class Mage_Admin_Model_Variable extends Mage_Core_Model_Abstract
{
    ...
    public function validate()
    {
        ...
        if (!Mage::helper('core')->isValidNotBlank($this->getVariableName())) {
        ...
        if (Mage::getModel('adminhtml/email_pathValidator')->isValid($this->getVariableName())) {
    ...
    {
        $value = $this->getData('variable_name');
