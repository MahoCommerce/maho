 ...
 * @method float getBaseBalanceBefore()
 * @method $this setBaseBalanceBefore(float $value)
 * @method float getBaseBalanceAfter()
 * @method $this setBaseBalanceAfter(float $value)
