...
/**
 * Scan history grid embedded in the accessibility dashboard.
 *
...
class Maho_AccessibilityScan_Block_Adminhtml_Dashboard_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
