...
{
    #[Maho\Config\CronJob(configPath: 'customer/customer_segments/cron_schedule', name: 'customersegmentation_refresh_segments')]
     ...
     */
    #[Maho\Config\CronJob('*/5 * * * *', name: 'customersegmentation_process_emails')]
     ...
     */
    #[Maho\Config\CronJob('0 2 * * *', name: 'customersegmentation_cleanup_progress')]
     ...
     */
    #[Maho\Config\CronJob('0 3 * * *', name: 'customersegmentation_cleanup_coupons')]
     ...
     */
    #[Maho\Config\CronJob('0 4 * * *', name: 'customersegmentation_automation_report')]
