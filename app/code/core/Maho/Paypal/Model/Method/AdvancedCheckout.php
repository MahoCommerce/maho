...
class Maho_Paypal_Model_Method_AdvancedCheckout extends Mage_Payment_Model_Method_Cc
{
    ...
    public function authorize(\Maho\DataObject $payment, $amount): self
    {
        ...
        if (!$paypalOrderId) {
            Mage::throwException('PayPal order ID not found.');
        }
        ...
        $this->_importProcessorResponse($result, $payment);
    ...
    public function capture(\Maho\DataObject $payment, $amount): self
    {
        ...
        if ($authId) {
            ...
            Mage::throwException('No PayPal authorization or order ID found for capture.');
        }
    ...
    public function refund(\Maho\DataObject $payment, $amount): self
    {
        ...
        if (!$captureId) {
            Mage::throwException('No PayPal capture ID found for refund.');
        }
    ...
    public function void(\Maho\DataObject $payment): self
    {
        ...
        if (!$authId) {
            Mage::throwException('No PayPal authorization ID found for void.');
        }
    ...
    protected function _importProcessorResponse(array $result, Mage_Payment_Model_Info $payment): void
    {
