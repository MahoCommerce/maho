...
/**
 * Backfill paypal_setup schema for M1.9 -> Maho migrations.
 *
 * upgrade-1.6.0.0-6.0.0.php only fires when paypal_setup.version is exactly
 * 1.6.0.0 (resolver requires infoFrom >= fromVersion). Shops at 1.6.0.1
 * through 1.6.0.6 get the version bumped to 6.0.0 with no tables. The
 * maho_setup pipeline keys off NULL maho_version and uses a > range, so
 * this file runs once per shop. All statements idempotent.
 */
