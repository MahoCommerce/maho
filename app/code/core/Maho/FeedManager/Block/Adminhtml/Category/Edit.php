...
class Maho_FeedManager_Block_Adminhtml_Category_Edit extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    {
        return (string) Mage::registry('current_platform');
    }

    public function getCurrentPlatformName(): string
    {
        $code = $this->getCurrentPlatform();
        if ($code) {
