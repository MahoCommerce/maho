...
class Maho_AdminActivityLog_Model_Observer
{
    ...
    #[Maho\Config\Observer('admin_user_authenticate_after', area: 'adminhtml', name: 'adminactivitylog_login_success')]
    ...
    #[Maho\Config\Observer('admin_session_user_logout', area: 'adminhtml', name: 'adminactivitylog_logout')]
    ...
    #[Maho\Config\Observer('admin_session_user_login_failed', area: 'adminhtml', name: 'adminactivitylog_login_failed')]
    ...
    #[Maho\Config\Observer('model_save_before', area: 'adminhtml', name: 'adminactivitylog_save_before')]
    #[Maho\Config\Observer('model_delete_before', area: 'adminhtml', name: 'adminactivitylog_delete_before')]
    ...
    #[Maho\Config\Observer('model_save_after', area: 'adminhtml', name: 'adminactivitylog_save_after')]
    ...
    #[Maho\Config\Observer('model_delete_after', area: 'adminhtml', name: 'adminactivitylog_delete_after')]
    ...
    #[Maho\Config\Observer('controller_action_predispatch_adminhtml', area: 'adminhtml', name: 'adminactivitylog_page_visit')]
    ...
    #[Maho\Config\Observer('controller_action_postdispatch_adminhtml', area: 'adminhtml', name: 'adminactivitylog_mass_action')]
    ...
    #[Maho\Config\Observer('encryption_key_regenerated', name: 'adminactivitylog_recrypt_data')]
