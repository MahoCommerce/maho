...
class HealthCheck extends BaseMahoCommand
{
    ...
    private const VARIEN_TO_MAHO_MAP = [
        'Varien_Convert' => 'Maho\\Convert',
        'Varien_Convert_Action_Abstract' => 'Maho\\Convert\\Action\\AbstractAction',
        'Varien_Convert_Action_Interface' => 'Maho\\Convert\\Action\\ActionInterface',
        'Varien_Convert_Container_Abstract' => 'Maho\\Convert\\Container\\AbstractContainer',
        'Varien_Convert_Container_Interface' => 'Maho\\Convert\\Container\\ContainerInterface',
        'Varien_Convert_Mapper_Abstract' => 'Maho\\Convert\\Mapper\\AbstractMapper',
        'Varien_Convert_Mapper_Interface' => 'Maho\\Convert\\Mapper\\MapperInterface',
        'Varien_Convert_Parser_Abstract' => 'Maho\\Convert\\Parser\\AbstractParser',
        'Varien_Convert_Parser_Interface' => 'Maho\\Convert\\Parser\\ParserInterface',
        'Varien_Convert_Profile_Abstract' => 'Maho\\Convert\\Profile\\AbstractProfile',
        'Varien_Data_Collection' => 'Maho\\Data\\Collection',
        'Varien_Data_Collection_Db' => 'Maho\\Data\\Collection\\Db',
        'Varien_Data_Collection_Filesystem' => 'Maho\\Data\\Collection\\Filesystem',
        'Varien_Data_Form' => 'Maho\\Data\\Form',
        'Varien_Data_Form_Abstract' => 'Maho\\Data\\Form\\AbstractForm',
        'Varien_Data_Form_Element_Abstract' => 'Maho\\Data\\Form\\Element\\AbstractElement',
        'Varien_Data_Form_Element_Renderer_Interface' => 'Maho\\Data\\Form\\Element\\Renderer\\RendererInterface',
        'Varien_Data_Form_Filter_Interface' => 'Maho\\Data\\Form\\Filter\\FilterInterface',
        'Varien_Data_Tree' => 'Maho\\Data\\Tree',
        'Varien_Data_Tree_Node' => 'Maho\\Data\\Tree\\Node',
        'Varien_Data_Tree_Node_Collection' => 'Maho\\Data\\Tree\\Node\\Collection',
        'Varien_Db_Adapter_Interface' => 'Maho\\Db\\Adapter\\AdapterInterface',
        'Varien_Db_Adapter_Pdo_Mysql' => 'Maho\\Db\\Adapter\\Pdo\\Mysql',
        'Varien_Db_Ddl_Table' => 'Maho\\Db\\Ddl\\Table',
        'Varien_Db_Expr' => 'Maho\\Db\\Expr',
        'Varien_Db_Select' => 'Maho\\Db\\Select',
        'Varien_Db_Helper' => 'Maho\\Db\\Helper',
        'Varien_Event' => 'Maho\\Event',
        'Varien_Event_Collection' => 'Maho\\Event\\Collection',
        'Varien_Event_Observer' => 'Maho\\Event\\Observer',
        'Varien_Event_Observer_Collection' => 'Maho\\Event\\Observer\\Collection',
        'Varien_File_Csv' => 'Maho\\File\\Csv',
        'Varien_File_Uploader' => 'Maho\\File\\Uploader',
        'Varien_Filter_Array' => 'Maho\\Filter\\ArrayFilter',
        'Varien_Filter_Object' => 'Maho\\Filter\\ObjectFilter',
        'Varien_Filter_Template' => 'Maho\\Filter\\Template',
        'Varien_Filter_Template_Tokenizer_Abstract' => 'Maho\\Filter\\Template\\Tokenizer\\AbstractTokenizer',
        'Varien_Io_Abstract' => 'Maho\\Io\\AbstractIo',
        'Varien_Io_File' => 'Maho\\Io\\File',
        'Varien_Io_Ftp' => 'Maho\\Io\\Ftp',
        'Varien_Io_Interface' => 'Maho\\Io\\IoInterface',
        'Varien_Io_Sftp' => 'Maho\\Io\\Sftp',
        'Varien_Object' => 'Maho\\DataObject',
        'Varien_Object_Cache' => 'Maho\\DataObject\\Cache',
        'Varien_Object_Mapper' => 'Maho\\DataObject\\Mapper',
        'Varien_Simplexml_Config' => 'Maho\\Simplexml\\Config',
        'Varien_Simplexml_Element' => 'Maho\\Simplexml\\Element',
        'Varien_Exception' => 'Maho\\Exception',
        'Varien_Profiler' => 'Maho\\Profiler',
    ];
