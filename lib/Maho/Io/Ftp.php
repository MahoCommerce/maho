...
class Ftp extends \Maho\Io implements IoInterface
{
    ...
    public function open(array $args = [])
    {
        if (empty($args['host'])) {
            ...
            throw new Exception('Empty host specified');
        }
        ...
        if (!$this->_conn) {
            ...
            throw new Exception('Could not establish FTP connection, invalid host or port');
        }
        ...
        if (!empty($this->_config['passive'])) {
            if (!@ftp_pasv($this->_conn, true)) {
                ...
                $this->close();
                throw new Exception('Invalid file transfer mode');
            }
        }
