...
readonly class Observer
{
     ...
     * @param ?string $name     Observer name, auto-generated if omitted. Set explicitly when other code references this observer by name.
     * @param ?string $replaces The `name` of another observer on the same event/area to disable and replace.
     *                          Accepts either the explicit name, the class name, or the class alias format
