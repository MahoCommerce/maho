...
beforeEach(function () {
    setSessionProperty('sessionLifetime', null);
    setSessionProperty('sessionLifetimeFallback', null);
...
describe('observer precedence', function () {
    it('prefers a lifetime supplied by an observer over configuration', function () {
        ...
        expect(invokeOnSession('getSessionLifetime'))->toBe(2592000);
    });
    ...
    it('has the storefront observer supply the plain lifetime without Remember Me', function () {
        ...
        expect(invokeOnSession('getSessionLifetime'))->toBe(604800);
    });
    ...
    it('has the admin observer supply the admin lifetime', function () {
        ...
        expect(invokeOnSession('getSessionLifetime'))->toBe(10800);
    });
...
describe('what the storage actually receives', function () {
    it('hands the resolved lifetime to the session storage instead of the PHP default', function () {
        // The bug this fixes: the computed lifetime never reached session.gc_maxlifetime,
        // which stayed at PHP's 1440 default.
        setSessionProperty('sessionLifetimeFallback', 604800);

        expect(invokeOnSession('getSessionLifetime'))
            ->toBe(604800)
            ->not->toBe(1440);
    });
});
