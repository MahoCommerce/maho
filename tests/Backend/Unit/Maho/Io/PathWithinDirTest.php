...
describe('\Maho\Io::getPathWithinDir()', function () {
    beforeEach(function () {
    ...
    it('does not expand a home directory shortcut', function () {
        expect(\Maho\Io::getPathWithinDir($this->base, '~/file.txt'))
    ...
    it('accepts an absolute path spelled through a symlink to the base directory', function () {
        ...
        expect(\Maho\Io::getPathWithinDir(realpath($this->base), $viaAlias))->toBe($viaAlias);
    ...
    it('accepts a symlink that stays inside the base directory', function () {
        ...
        expect(\Maho\Io::getPathWithinDir($this->base, 'link/file.txt'))
