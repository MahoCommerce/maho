...
import { Editor, Node, Mark, Extension, mergeAttributes } from 'https://esm.sh/@tiptap/core@3.7';
import StarterKit from 'https://esm.sh/@tiptap/starter-kit@3.7';
import Image from 'https://esm.sh/@tiptap/extension-image@3.7';
import TextAlign from 'https://esm.sh/@tiptap/extension-text-align@3.7';
import { Table, TableRow, TableCell, TableHeader } from 'https://esm.sh/@tiptap/extension-table@3.7';
import BubbleMenu from 'https://esm.sh/@tiptap/extension-bubble-menu@3.7';
